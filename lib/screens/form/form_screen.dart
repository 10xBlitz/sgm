...
class _FormScreenState extends State<FormScreen> {
                ...
                child: ListView(
                  ...
                  children: [
                    ...
                    CustomDropdownContainer<String>(
                      ...
                      required: true,
                      isCountryPicker: true,
                      onSelect: (val) => _dropdownAnswers[kCountryResidence] = val,
                      items: const [],
                    ),
                    const SizedBox(height: 20),
                    _TextFieldWidget(
  ...
  void _submitForm() {
    ...
    ScaffoldMessenger.of(context).showSnackBar(const SnackBar(content: Text('Form submitted! (see debug output)')));
  }
}
